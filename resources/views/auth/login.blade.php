            ...
            @if($errors->any())
                <div class="bg-red-50 border-l-4 border-red-400 p-4 rounded-lg">
                    <div class="flex">
                        ...
                        <div>
                            <p class="text-red-700 font-medium mb-2">Giriş sırasında hata oluştu:</p>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                value="{{ old('email') }}"
                                required
                                class="appearance-none relative block w-full px-4 py-4 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 text-lg transition-all duration-200"
